...
@Component({
  selector: 'app-liste-inactifs',
  templateUrl: './liste-inactifs.component.html',
  styleUrls: ['./liste-inactifs.component.scss']
})
export class ListeInactifsComponent implements OnInit {
